...
class UnityTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # commands.getoutput('adb -s 95fe1b64 shell ls /data/local/tmp')
        commands.getoutput('adb -s 95fe1b64 shell touch /data/local/tmp/LVR_MONKEY_TEST')
        commands.getoutput('adb -s 95fe1b64 shell touch /sdcard/LVR_MONKEY_TEST')
    ...
    def tearDown(self):
        ...
        commands.getoutput('adb -s 95fe1b64 shell /system/bin/screencap -p /sdcard/%s.png'%(end_time))
        ...
        try:
            ...
            pass
        commands.getoutput('adb -s 95fe1b64 shell logcat -v time -d > %s/0_logcat_%s.txt'%(str_path,str(int(end_time))))
        commands.getoutput('adb -s 95fe1b64 bugreport > %s/0_bugreport.log'%str_path)
        commands.getoutput('adb -s 95fe1b64 pull /sdcard/%s.png %s/%s'%(end_time,os.getcwd(),str_path))

    # def goVRLauncher(self):
    #     commands.getoutput('adb -s 95fe1b64 shell am start -n com.lvr.launcher/.VRLauncherActivity --es pkgName com.lvr.wizzard')
    #     time.sleep(5)
    ...
    def goVRApp(self, app):
        ...
        commands.getoutput('adb -s 95fe1b64 shell am start -n %s'%apps[app][1])
        time.sleep(10)
